...
<img src="images/factor_exposure.png" width="900" alt="Factor exposure expander: Fama-French loadings, annualised alpha, R-squared">
...
<img src="images/forecast_fan_chart_ML.png" width="900" alt="Forecast fan chart comparing 4 assets (AAPL/AVGO/LLY/WMT) using ML regression (gradient boosting), each with its own 95% confidence band widening with horizon">
...
<img src="images/forecast_fan_chart_LSTM.png" width="900" alt="Forecast fan chart comparing the same 4 assets using LSTM (recurrent neural net), showing a mild trend continuation instead">
...
<img src="images/walk_forward_distrib.png" width="900" alt="Box plot of Sharpe ratio across 5 walk-forward windows for the three portfolio types, with the forecast-vs-historical win rate">

**Walk-forward validation — period-over-period**
<img src="images/walk_forward_period.png" width="900" alt="Each portfolio type's own trajectory window by window, current value next to the previous window's value">
...
<img src="images/sentiment_sources.png" width="650" alt="News sentiment by ticker (FinBERT financial-domain model), tagged by source">
...
<img src="images/chatbot_1.png" width="900" alt="Chatbot answering a risk-profile and time-horizon question, flagging its own annualised-return caveat on a short window">
<img src="images/chatbot_2.png" width="900" alt="Chatbot follow-up building a core-satellite allocation framework, context retained across turns">
...
<img src="images/chatbot_5.png" width="900" alt="Chatbot explaining why MSFT sentiment is bearish, combining the negative model weight, the one filed 8-K, and the current macro backdrop">
